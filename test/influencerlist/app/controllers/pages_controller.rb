class PagesController < ApplicationController
  ...
  def home
    ...
    @ids.each do |id|
     ...
     @user_options = [["Sort by", ""],["Engagement (Low-High)", "statistics engagement desc."], ["Engagement (High-Low)", "statistics engagement asc."], ["Followers (Low-High)", "followers desc."], ["Followers (High-Low)", "followers asc."], ["Full Name", "name"]]
    ...
    if filter.nil?
      ...
      @influencers_starred = influencers_starred.compact.sort_by! { |a, b| a.statistics_engagement}
      ...
      influencers_starred.sort! { |a| a.statistics_followers }
    elsif filter == "name"
